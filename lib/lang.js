...
module.exports = function() {
    ...
    /**
    * This method gets a language object for the specific country.
    * @param {String} languageCode is a two digit country code. (e.g. 'en', 'de', ...)
    ...
    * This method gets a language object for the specific country.
    * @param {String} languageCode is a two digit country code. (e.g. 'en', 'de', ...)
    * @returns {Object} A language object that contains several translated words and texts. If the language could not be found, an empty object will be returned.
    */
